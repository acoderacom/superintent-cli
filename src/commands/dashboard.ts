...
import type { WikiSearchHit } from '../ui/components/index.js';
import type { DashboardData, HealthStatus, UsageHealth, CitationHealth, KnowledgeHealthData, WikiCoverageData } from '../ui/components/dashboard.js';
